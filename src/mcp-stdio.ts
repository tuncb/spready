...
const guideResource = {
  ...
  usageConventions: [
    ...
    "sortTable sorts table body rows only. Blank sort values are placed after nonblank values. Raw mode sorts stored input strings; display mode sorts evaluated typed values. Formula strings move with rows and are not rewritten.",
