...
const guideResource = {
  ...
  usageConventions: [
    ...
    "Evaluated display reads include arithmetic, comparisons, text operators, same-sheet and cross-sheet ranges, core worksheet functions, and lookup functions such as INDEX, MATCH, XLOOKUP, and VLOOKUP.",
