...
const guideResource = {
  ...
  usageConventions: [
    ...
    "Evaluated display reads include arithmetic, comparisons, text operators, same-sheet and cross-sheet ranges, core worksheet functions, date/time functions such as TODAY, NOW, DATE, YEAR, MONTH, and DAY, and lookup functions such as INDEX, MATCH, XLOOKUP, and VLOOKUP.",
