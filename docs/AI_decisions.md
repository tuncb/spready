...
- Table column threshold highlights are persisted as table metadata and rendered as derived UI styling so automation can configure highlights without mutating per-cell styles.
